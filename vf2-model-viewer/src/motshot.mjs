...
const att=g("motAttach")(sc,pl,Us);
...
{ const E2=g("motEngine")(prog,new Uint8Array(mem),md); scenes.push({sc:g("motApply")(sc,att,E2.frame(pl,info.frame)),label:"計算"}) }
E.start(pl,m); for(const f of frames) scenes.push({sc:g("motApply")(sc,att,E.frame(pl,f)),label:m+":"+f});
